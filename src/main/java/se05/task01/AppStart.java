...
public class AppStart {
    ...
    private static void showHelp() {
        ...
        System.out.println("delete [file_name.extension] - deletes a [file_name.extension] file from current directory;");
        ...
        System.out.println("rewrite [file_name]          - rewrites a .txt [file_name] with the text you enter;");
        System.out.println("addto [file_name]            - adds to a .txt [file_name] text you enter;");
